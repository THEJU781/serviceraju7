...
function get_plan_expiration_date($plan_start_date = '',$plan_type = '',$left_days = 0){
    ...
    if($plan_type === 'monthly'){
        $end_date =  $start_at->modify('next month')->addDays($left_days);
    }
    if($plan_type === 'yearly'){
        $end_date =  $start_at->modify('next year')->addDays($left_days);
    }
