                ...
                <div class="modal-dialog">
                    ...
                    {{ Form::open(['method' => 'POST','route' => 'togglesetting']) }}
                        ...
                        @if(($data['dashboard_setting'] != [] && !empty($data['dashboard_setting']->New_Provider_card)) || $show == "true")          
                            {{Form::checkbox('New Provider card', "new_provider_card", true)}}New Provider card<br>       
                        @else
                            {{Form::checkbox('New Provider card', "new_provider_card", false)}}New Provider card<br>      
                        @endif
