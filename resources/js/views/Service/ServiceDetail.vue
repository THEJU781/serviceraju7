...
<div class="service-detail service-main mar-bot">
    ...
    <div class="service-content-part mar-top">
                            ...
                            <div class="provider-info">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="provider-content mt-3 mt-sm-0 w-100">
                                        ...
                                        <a href="mailto:demo@example.com" class="btn btn-primary mt-4">{{__('messages.contact')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>                            
                    ...
                    <div class="card" v-if="serviceData.duration">
                        <div class="card-body">
                            ...
                            <div class="duration-details">
                                <p>This service may take <strong class="text-primary"> {{serviceData.duration}} Hour </strong>to Complete</p>
                            </div>
                        </div>                            
                    </div>
     ...
     <div class="service-book-now">
        <router-link :to="{name:'book-service'}" class="btn btn-primary rounded"> Book Now </router-link>
    </div>
    <b-modal id="reviewedit" modal-class="modal fade" title="Review" header-close-content=" <button type='button' class='btn-close btn-sm' data-bs-dismiss='modal' aria-label='Close'></button>">
        <form class="review-form">
                ...
                <button type="submit" class="btn btn-primary mt-3" data-bs-dismiss='modal'>Update</button>
            </form> 
    </b-modal>
</div>
</template>
...
export default {
  components: { Favorite },
    ...
    methods:{
        ...
        //  init () {
        //        new Swiper('.offerSlider', this.option)
        // },
    }
}
</script>
